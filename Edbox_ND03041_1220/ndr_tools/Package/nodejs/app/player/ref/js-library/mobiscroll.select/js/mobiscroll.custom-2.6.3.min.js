(function(a) {
    function m(f, c) {
        ...
        function r(c) {
            ...
            x ? (a.each(["t", "webkitT", "MozT", "OT", "msT"], function(a, c) {
                if (void 0 !== g[c + "ransform"])
                    return b = g[c + "ransform"], !1
        ...
        function K(c, g, b, k, y) {
            !1 !== E("validate", [v, g, c]) && (a(".dw-ul", v).each(function(b) {
                var h = a(this),
                    ...
                    I = b == g || void 0 === g;
                if (!e.hasClass("dw-v")) {
                    for (var o = e, d = 0, l = 0; 0 <= f - d && !o.hasClass("dw-v");)
                        d++, o = i.eq(f - d);
                    for (; f + l <
                        j && !e.hasClass("dw-v");)
                        l++, e = i.eq(f + l);
                ...
                if (!e.hasClass("dw-sel") || I)
                    n.temp[b] = e.attr("data-val"), a(".dw-sel", h).removeClass("dw-sel"), p.multiple || (a(".dw-sel", h).removeAttr("aria-selected"), e.attr("aria-selected", "true")), e.addClass("dw-sel"), m(h, b, f, I ? c : 0.1, I ? y : !1)
        ...
        var na,
            ...
            Fa = function(c) {
                ...
                fa && (a.preventDefault(), a.stopPropagation(), _active = !0, U = A(a, "Y"), m(L, M, Math.max(Y -
        ...
        n.getValues = function() {
            var a = [],
                c;
            for (c in n._selectedValues)
                a.push(n._selectedValues[c]);
            return a
        };
            ...
            if (v) {
                ...
                a.each(p.wheels, function(e, h) {
                    a.each(h, function(e, h) {
                        if (-1 < a.inArray(b, c) && (la[b] = h, a(".dw-ul", v).eq(b).html(y(b)), k--, !k))
                            return n.position(), K(g, void 0, !0), !1;
                        b++
                    });
                    if (!k)
                        return !1
        ...
        n.show = function(c) {
            ...
            if ("inline" != p.display) {
                ...
                if (p.scrollLock)
                    v.on("touchmove touchstart", function(a) {
                        sa && a.preventDefault()
                    });
            ...
            a(".dwwl", v).on(C, Fa).on("keydown", Ha).on("keyup", Ia);
        ...
        n.init = function(a) {
            ...
            n.settings = p;
            G.off(".dw");
            if (a = wa.presets[p.preset])
                qa = a.call(N, n), i(p, qa, c);
            ...
            if ("inline" == p.display)
                ...
                l();
                if (aa && (void 0 === ua && (ua = N.readOnly), N.readOnly = !0, p.showOnFocus))
                    G.on("focus.dw", function() {
                        va || n.show();
                        va = false
                    });
    ...
    function l(a, c, b) {
        ...
        "string" === typeof c && a.each(function() {
            var a;
            if ((a = q[this.id]) && a[c])
                if (a = a[c].apply(this, Array.prototype.slice.call(b, 1)), void 0 !== a)
                    return k = a, !1
        });
        return k
    }
    var e, j, t, s, o, f = (new Date).getTime(),
        q = {}, b = function() {}, r = document.createElement("modernizr").style,
...
(function(a) {
            ...
            if (J.match(/date/i)) {
                ...
                for (o = 0; 3 > o; o++)
                    if (o == w.y) {
                        ...
                        D = E.getFullYear();
                        for (b = A; b <= D; b++)
                            r.push(b), x.push(c.match(/yy/i) ? b : (b + "").substr(2, 2));
                        e(q, r, x, i.yearText)
                    } else
                if (o == w.m) {
                    C++;
                    ...
                    r = [];
                    for (b = 0; 12 > b; b++)
                        A = c.replace(/[dy]/gi, "").replace(/mm/, 9 > b ? "0" + (b + 1) : b + 1).replace(/m/, b + 1),
                    ...
                    r = [];
                    for (b = 1; 32 > b; b++)
                        r.push(b), x.push(c.match(/dd/i) && 10 > b ? "0" + b : b);
                    e(q, r, x, i.dayText)
                }
                s.push(q)
            }
            if (J.match(/time/i)) {
                ...
                for (o = C; o < C + 4; o++)
                    if (o == w.h) {
                        ...
                        x = [];
                        r = [];
                        for (b = 0; b < (h ? 12 : 24); b += da)
                            r.push(b), x.push(h && 0 == b ? 12 : g.match(/hh/i) && 10 > b ? "0" + b : b);
                        e(q, r, x, i.hourText)
                    } else
                if (o == w.i) {
                    C++;
                    ...
                    r = [];
                    for (b = 0; 60 > b; b += oa)
                        r.push(b), x.push(g.match(/ii/) && 10 > b ? "0" + b : b);
                    ...
                    r = [];
                    for (b = 0; 60 > b; b += pa)
                        r.push(b), x.push(g.match(/ss/) && 10 > b ? "0" + b : b);
                    e(q, r, x, i.secText)
                } else
                    o == w.a && (C++, r = g.match(/A/), e(q, [0, 1], r ? ["AM", "PM"] : ["am", "pm"], i.ampmText));
                s.push(q)
            }
            d.setDate = function(a,
                c, b, g) {
                for (var k in w)
                    d.temp[w[k]] = a[B[k]] ? a[B[k]]() : B[k](a);
    ...
    m.formatDate = function(d, l, e) {
        ...
        var e = a.extend({}, z, e),
            j = function(a) {
                for (var b = 0; o + 1 < d.length && d.charAt(o + 1) == a;)
                    b++, o++;
                return b
            }, t = function(a, b, d) {
                b = "" + b;
    ...
    m.parseDate = function(d, l, e) {
        ...
        var l = "object" == typeof l ? l.toString() : l + "",
            ...
            D = function(a) {
                ...
                for (b = 0; b < a.length; b++)
                    if (l.substr(u, a[b].length).toLowerCase() == a[b].toLowerCase())
                        return u += a[b].length, b + 1;
                return 0
            }, u = 0,
            w;
        ...
        if (b.getFullYear() != e || b.getMonth() + 1 != o || b.getDate() != f)
            throw "Invalid date";
        return b
    }
})(jQuery);
        ...
        d = {
            ...
            function j(a, b, k) {
                ...
                for (; d < a.length;) {
                    ...
                    for (var b = d, j = i, m = {
                        ...
                        m.values.push(j[l].value), m.keys.push(j[l].key), l++;
                    h[b] = [m];
                    h = 0;
                    for (b = void 0; h < i.length && void 0 === b;) {
                        if (i[h].key == a[d] && (void 0 !== k && d <= k || void 0 === k))
                            b = h;
                        h++
                    }
                    if (void 0 !== b && i[b].children)
                        d++, i = i[b].children;
                    else if ((e = t(i)) && e.children)
                        d++, i = e.children;
                    else
                        break
                }
            ...
            function o(a, b) {
                ...
                if (void 0 !== a[h] && h <= b) {
                    f = 0;
                    i = a[h];
                    for (j = void 0; f < e.length && void 0 === j;)
                        e[f].key == a[h] && !e[f].invalid && (j = f), f++
                } else
                    j = t(e, !0), i = e[j].key;
                ...
                for (d[h] = i; f;) {
                    ...
                    if (void 0 !== a[h] && h <= b) {
                        ...
                        j = t(e, !0), j = !1 === j ? void 0 : j, i = e[j].key;
            ...
            var q = a.extend({}, m.settings),
                ...
                D = 0,
                i = 0,
                C = {}, u = b.wheelArray || f(q),
                w =
                    function(a) {
                        var d = [],
                            e;
                        for (e = 0; e < a; e++)
                            d[e] = b.labels && b.labels[e] ? b.labels[e] : e;
                        return d
                }(D),
                B = [],
                J = function(a) {
                    for (var b = [], d, e = !0, f = 0; e;)
                        if (d = t(a), b[f++] = d.key, e = d.children)
                            a = d.children;
                    return b
                }(u),
                J = j(J, D);
    ...
    a.mobiscroll.presets.select = function(d) {
        ...
        function A(a, e) {
            ...
            if (t) {
                var l = [],
                    h = 0;
                for (h in d._selectedValues)
                    l.push(i[h]), f.push(h);
                B.val(l.join(", "))
            } else
                B.val(a), f = e ? d.values[u] : null;
        ...
        return {
            ...
            validate: function(b, g, i) {
                if (g === void 0 && t) {
                    ...
                    for (h in l)
                        a(".dwwl" + u + ' .dw-li[data-val="' + l[h] + '"]', b).addClass("dw-msel").attr("aria-selected", "true")
                }
                if (g === C) {
                    q = d.temp[C];
                    if (q !== f) {
            ...
            onBeforeShow: function() {
                e.wheels = z();
                if (e.group)
                    d.temp = e.rtl ? [s, o.index()] : [o.index(), s]
            },
            onMarkupReady: function(b) {
                ...
                if (t) {
                    ...
                    D = {};
                    for (var e in d._selectedValues)
                        D[e] = d._selectedValues[e]
                }
            },
            onValueTap: F,
            onSelect: function(a) {
