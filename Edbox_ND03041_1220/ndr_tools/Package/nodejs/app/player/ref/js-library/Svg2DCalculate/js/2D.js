...
Rectangle.prototype.getIntersectionParams = function () {
    ...
    window.Svg2DCalculate = {};
    window.Svg2DCalculate.Intersection = Intersection;
    window.Svg2DCalculate.Rectangle = Rectangle;
    window.Svg2DCalculate.Ellipse = Ellipse;
    window.Svg2DCalculate.Line = Line;
    window.Svg2DCalculate.Polygon = Polygon;
    window.Svg2DCalculate.Path = Path;
    window.Svg2DCalculate.Circle = Circle;
})()